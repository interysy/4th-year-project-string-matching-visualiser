...
\begin{abstract}
    String matching algorithms can be challenging to comprehend. Hence the focus of this project is the implementation of a web application, which via a clear UI, will act as support for students and enthusiasts learning about the Brute Force Approach, Boyer-Moore Horsepool and Knuth-Morris-Pratt algorithms. The product gives users the ability to step through animations and pseudocode during execution, while also displaying the current variable values and explaining what is happening. There exist many quality of life features, such as mobile support to further enhance the user experience. The product has undergone a testing and evaluation phase, which has confirmed its correct functionality and ability to improve user's knowledge of string matching algorithms.
